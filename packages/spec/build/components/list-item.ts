/* ──────────────────────────────────────────────────────────────
 * NURI · COMPONENT TOKENS · LIST-ITEM · GENERATED · DO NOT EDIT BY HAND
 *
 * Source · lib/components/list-item/list-item.css @layer tokens
...
export const listItem = {
  paddingBlock:  'space.md' as const satisfies TokenPath,
  gap:           'space.md' as const satisfies TokenPath,
} as const;
