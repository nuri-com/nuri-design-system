...
export const PROPERTY_SPELLING = {
  ...
  marginInline:       { rn: 'marginHorizontal',  css: 'margin-inline' },
  marginBlock:        { rn: 'marginVertical',    css: 'margin-block' },
  marginBlockStart:   { rn: 'marginTop',         css: 'margin-block-start' },
  marginBlockEnd:     { rn: 'marginBottom',      css: 'margin-block-end' },
