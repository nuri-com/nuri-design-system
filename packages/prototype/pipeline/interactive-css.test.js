...
// The token CSS stays in @nuri/spec (the token pipeline · convergence phase 4) — read across
// the package boundary via the sibling workspace (the build-free relative pattern · icon.js).
