/* ──────────────────────────────────────────────────────────────
 * NURI · COMPONENT DESCRIPTOR · BOTTOM-SHEET-PANEL · BROWSER ESM · GENERATED · DO NOT EDIT BY HAND
 *
 * The browser-ESM twin of packages/spec/components/bottom-sheet-panel.ts — IDENTICAL data,
 * the authored source type-stripped (no `import type`, no axes type, no
 * `: Descriptor<…>` annotation). A browser can `import { bottomSheetPanelDescriptor }`
 ...
 * what Nuri IS #3).
 *
 * Source · packages/spec/components/bottom-sheet-panel.ts (the AUTHORED SoT · §9 step 1 ·
...
export const bottomSheetPanelDescriptor = {
  structure: {
    anatomy: {
      el: 'view',
      open: true,
    ...
    base: {
      root: {
        ...
        box: { radiusTop: 'lg', paddingTop: 'md', paddingBottom: 'lg' },
