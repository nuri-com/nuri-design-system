...
// The bar renders its <nuri-tab-bar-item> children — pull in the item recipe
// (idempotent define-guard) so a page that links only tab-bar.js still gets the item.
import './tab-bar-item.js';
