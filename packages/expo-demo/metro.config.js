...
// the symlink chain expo-demo → @nuri/rn → @nuri/spec across the npm
...
// @nuri/rn's .ts) via babel-preset-expo like any in-tree source, and
...
// @nuri/rn is symlinked, and the workspace install nests its OWN
// react@19.1.0 under packages/rn while the app carries its own copy under
