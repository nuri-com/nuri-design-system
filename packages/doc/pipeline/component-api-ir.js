...
export const COMPONENT_API_DOCS = [
  ...
  },
  {
    ...
    title: 'Select Field',
    nav: 24,
    file: 'packages/rn/generated/components/select-field.ts',
    type: 'SelectFieldProps',
    relatedPrefix: 'SelectField',
  ...
  },
  {
    ...
    title: 'Modal',
    nav: 21,
    file: 'packages/rn/primitives/Modal.tsx',
    type: 'ModalProps',
  },
  {
    source: 'modal-panel',
...
const NOTE_BY_PROP = {
  ...
  accessibilityValue: 'pressable behaviour',
  ...
  safeAreaChrome: 'safe-area chrome role',
  safeAreaBottom: 'safe-area reserve',
  insetTop: 'dock inset reserve',
  insetBottom: 'dock inset reserve',
  mode: 'presentation mode',
  scrim: 'sheet-mode behaviour',
  open: 'modal behaviour',
  dismissible: 'modal behaviour',
  onOpenChange: 'modal behaviour',
