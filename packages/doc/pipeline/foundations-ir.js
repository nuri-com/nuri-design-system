...
export const FOUNDATION_DOCS = [
  {
    ...
    nav: 1,
    src: 'packages/spec/pipeline/colours.ts',
  ...
  },
  {
    source: 'dimension',
    nav: 3,
    src: 'packages/spec/pipeline/dimensions.ts',
  ...
  },
  {
    source: 'typography',
    nav: 4,
    src: 'packages/spec/build/tokens.ts · packages/spec/styles/typography.css · packages/spec/styles/tokens-primitive.css',
