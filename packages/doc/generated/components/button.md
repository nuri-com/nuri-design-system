...
<!-- GENERATED · DO NOT EDIT BY HAND · source: packages/spec/components/composition-button.ts
...
| `size` | `sm` | `label` | `typography` | **size** `sm`<br>**emphasis** `true` | **fontSize** `15`<br>**lineHeight** `1.33`<br>**weight** `600`<br>**letterSpacing** `-0.01` |
