...
| 21 | `packages/spec/build/` is committed and CI drift-guards it (in the `spec` job · rule 22); the `packages/spec/pipeline/docs-drift.test.js` guards (component pages ↔ `llms.txt` · `packages/spec/build/components/*` ↔ README/impl-guide manifest · doc-stated counts ↔ live build · descriptor + palette re-emit · the frozen schema shape · Guard F · decision 65 step 5) must stay green | [decision 35](./decisionlog.md#35-pipeline-sources-vs-build-outputs-physically-separated--pipeline-source-build-generated-only--n604) · [gates.yml](./.github/workflows/gates.yml) |
