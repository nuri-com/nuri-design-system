...
const TS_PATH = resolve(RN_GENERATED, 'data/tokens.ts');
const INTERACTION_TS_PATH = resolve(RN_GENERATED, 'data/interaction.ts');
const TOKEN_PATHS_PATH = resolve(RN_GENERATED, 'data/token-paths.ts');
const ICONS_TS_PATH = resolve(RN_GENERATED, 'data/icons.ts');
